    ...
    Loader.prototype.Load = function () {
        ...
        switch (adrArr[0]) {
            ...
            case "Каталог":
                ...
                $("#price").html((i, html) => {
                    return html.replace(/25000р./g, "<s>25000р.</s>");
                });
                $("#newPrice").text("12500р.");
            ...
            case "Ваша визитка":
                ...
                $("#price").html((i, html) => {
                    return html.replace(/20000р./g, "<s>20000р.</s>");
                });
                $("#newPrice").text("10000р.");
            ...
            case "Корпоративное приложение":
                ...
                $("#price").html((i, html) => {
                    return html.replace(/35000р./g, "<s>35000р.</s>");
                });
                $("#newPrice").text("17500р.");
            ...
            case "Приложения для Android/iOS":
                $(".headmdiv > p").text("Мобильное приложение – это специально разработанное под функциональные возможности гаджетов программное обеспечение (ПО). С помошью мобильного приложения пользователям предоставляется более удобный доступ к сервисам. При этом использование мобильного приложения возможно в фоновом режиме без браузера и доступа к Интернету.");
                $("#price").text("Стоимость: Договорная.");
                $("#newPrice").text(null);
                $("#common").css("display", "block");
                type = "common";
